...
class FaceRecognitionNode:
    ...
    def load_known_faces(self):
        global cv_image
        for filename in os.listdir("/home/rafael/FestinoPumas/PC_user/src/Vision/face_recog/Train_faces/Image/"):
            name = os.path.splitext(filename)[0]
            image_path = os.path.join("/home/rafael/FestinoPumas/PC_user/src/Vision/face_recog/Train_faces/Image/", filename)
