...
public:
        ...
        bool toggleAlignment(std_srvs::SetBool::Request &req, std_srvs::SetBool::Response &res)
        {
            if (req.data)
            {
                ...
                std::cout<<"Line Aligner with Hokuyo --- Start aling with LaserScan."<<std::endl;
                ...
                is_align_enabled_ = false;
                res.success = true;
                res.message = "Line Aligner with Hokuyo --- Aling done.";
            }
            else {
                is_align_enabled_ = false;
                res.success = true;
                res.message = "Line Aligner with Hokuyo --- Aling disable";
            }
